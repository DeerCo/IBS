    ...
    client.query(sql_add_course, sql_add_data, (err, pgRes) => {
        if (err) {
            ...
            let sql_add_task_table = 
                ...
                "task_id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 ), " +
                ...
                "task_order integer NOT NULL DEFAULT 0, PRIMARY KEY (task_id), UNIQUE (task)" +
                ");";
            let sql_add_criteria_table = 
                ...
                "task_id integer NOT NULL, criteria character varying NOT NULL, total numeric NOT NULL, " +
                "description character varying, criteria_order integer NOT NULL DEFAULT 0, " +
                "PRIMARY KEY (criteria_id), UNIQUE (task_id, criteria), " +
                "CONSTRAINT task_id FOREIGN KEY (task_id) REFERENCES " + task_table_name + " (task_id) MATCH SIMPLE " +
            ...
            let sql_add_group_table = 
                ...
                "task_id integer NOT NULL, extension integer, PRIMARY KEY (group_id), " +
                "CONSTRAINT task_id FOREIGN KEY (task_id) REFERENCES " + task_table_name +" (task_id) MATCH SIMPLE " +
                "ON UPDATE RESTRICT ON DELETE RESTRICT NOT VALID" + 
                ");";
            let sql_add_group_user_table = 
                "CREATE TABLE " + group_user_table_name + "(" +
                "task_id integer NOT NULL, username character varying NOT NULL, group_id integer NOT NULL, " +
                "status character varying NOT NULL, PRIMARY KEY (task_id, username),  " +
            ...
            let sql_all = sql_add_schema + sql_add_task_table + sql_add_criteria_table + 
