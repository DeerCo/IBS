...
const TaskForm = ({ mode, initialValues }) => {
    ...
    useEffect(() => {
        ...
        InstructorApi.all_tasks(course_id).then((response) => {
                ...
                <Grid container item rowSpacing={2}>
                    ...
                    {interview_groups && (
                        <Grid item xs={12}>
                            <TextField
                                ...
                                error={
                                    formik.touched.interview_group &&
                                    Boolean(formik.errors.interview_group)
                                }
                            >
                    ...
                    {task_group_ids && (
                        <Grid item xs={12}>
                            <TextField
                                ...
                                error={
                                    formik.touched.task_group_id &&
                                    Boolean(formik.errors.task_group_id)
                                }
                            >
                                <MenuItem Key="None" value={undefined}>
                                    <em>None</em>
                    ...
                    <Grid item xs={12}>
                        <TextField
                            ...
                            error={
                                formik.touched.starter_code_url &&
                                Boolean(formik.errors.starter_code_url)
                            }
                        />
                    </Grid>
                    ...
                    <Grid container item flexDirection="row" justifyContent="space-between">
                        ...
                        <Grid item>
                            ...
                            <Switch
                                ...
                                error={
                                    formik.touched.change_group &&
                                    Boolean(formik.errors.change_group)
                                }
                            />
                        </Grid>
                        <Grid item>
                            ...
                            <Switch
                                ...
                                error={
                                    formik.touched.hide_interview &&
                                    Boolean(formik.errors.hide_interview)
                                }
                            />
                        </Grid>
                        <Grid item>
